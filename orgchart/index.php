...
<html>
<head>
    <title>Org Chart - PageUp Concepts</title>
    ...
    <link href="demo/css/primitives.latest.css?215" media="screen" rel="stylesheet" type="text/css" />
    <script  type="text/javascript" src="demo/js/primitives.min.js?215"></script>
            ...
            var itemTemplate = jQuery(
			  '<div class="bp-item bp-corner-all bt-item-frame">'
				+ '<div name="titleBackground" class="bp-item bp-corner-all bp-title-frame" style="top: 2px; left: 2px; width: 216px; height: 20px;">'
					...
					+ '</div>'
				+ '</div>'
				+ '<div class="bp-item h4" style="top: 26px; left: 2px; width: 50px; height: 60px;">'
            ...
            var itemTemplate = jQuery(
              '<div class="bp-item bp-corner-all bt-item-frame">'
                + '<div name="titleBackground" class="bp-item bp-corner-all bp-title-frame" style="top: 2px; left: 2px; width: 176px; height: 18px; overflow: hidden; text-align:center;">'
                    ...
                    + '</div>'
                + '</div>'
                + '<div class="bp-item h4" style="top: 22px; left: 2px; width: 50px; height: 60px; overflow: hidden;">'
                    + '<img name="photo" style="height:60px; width:50px;" />'
                + '</div>'
...
<body>
    <div id="contentpanel" style="padding: 0px; ">
        ...
        <div id="centerpanel" style="overflow: hidden; padding: 0px; margin: 0px; border: 0px; background-color:#F2F2F2">
        </div>
