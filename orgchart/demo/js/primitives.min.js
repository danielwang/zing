/*
 Basic Primitives orgDiagram v2.0.15
...
primitives.orgdiagram.BaseController.prototype._getTreeItemForMousePosition=function(a,b){var c=null,d,e,f,g,h,j,i,k,l;this.graphics.activate("placeholder",7);a/=this.scale;b/=this.scale;this.transform.transformPoint(a,b,!1,this,function(a,b){d=0;for(e=this._treeLevels.length;d<e;d+=1)if(g=this._treeLevels[d],b>g.topConnectorShift&&b<=g.connectorShift){j=h=null;k=0;for(f=g.treeItems.length;k<f;k+=1)switch(i=this._treeItems[g.treeItems[k]],i.actualVisibility){case 1:if(i.actualPosition.contains(a,
...
Math.min(g.actualVisibility,e.actualVisibility),(0<e.partners.length||0<e.extraPartners.length)&&j.push(new primitives.orgdiagram.TreeItemsGroup(e));if(0<j.length){c=0;for(d=j.length;c<d;c+=1){i=j[c];k=i.treeItem.partners.slice(0).concat(i.treeItem.extraPartners);e=0;for(f=k.length;e<f;e+=1)h=this._treeItems[k[e]],h=h.offset+h.actualSize.width/2,i.startIndex=null!=i.startIndex?Math.min(i.startIndex,h):h,i.endIndex=null!=i.endIndex?Math.max(i.endIndex,h):h}g.partnerConnectorOffset=this._setConnectorsOffset(j)}}};
primitives.orgdiagram.BaseController.prototype._setConnectorsOffset=function(a){var b=0,c,d,e,f,g,h,j,i=[],k,l,n,m,p,q;a.sort(function(a,b){return a.endIndex-a.startIndex-(b.endIndex-b.startIndex)});f=0;for(g=a.length;f<g;f+=1){e=a[f];d=c=0;n=new primitives.orgdiagram.PositionOffset(e.startIndex,c+1);m=new primitives.orgdiagram.PositionOffset(e.endIndex,d);j=i.length;if(0<j){k=[];q=p=!1;for(h=0;h<j;h+=1)l=i[h],l.position<n.position?(k.push(l),d=c=l.offset):l.position<m.position?(p||(k.push(n),p=!0),
c=Math.max(c,l.offset),d=l.offset):(p||(k.push(n),p=!0),q||(k.push(m),q=!0,n.offset=c+1,m.offset=d),k.push(l));p||(k.push(n),p=!0);q||(k.push(m),q=!0,n.offset=c+1,m.offset=d);i=k}else i=[n,m];e.treeItem.partnerConnectorOffset=n.offset;b=Math.max(b,n.offset)}return b};
...
primitives.orgdiagram.Controller.prototype._createOrgTree=function(){var a,b,c,d,e,f,g,h,j,i,k;this._treeItemConfigs={};this._orgItems={};this._orgItemChildren={};this._orgItemRoot=null;if(null!=this.options.items&&0<this.options.items.length){h="title description image itemTitleColor groupTitle groupTitleColor isVisible hasSelectorCheckbox hasButtons itemType adviserPlacementType childrenPlacementType templateName showCallout calloutTemplateName label showLabel labelSize labelOrientation labelPlacement".split(" ");j=
...
primitives.orgdiagram.TreeLevel.prototype.toString=function(){return this.level+"."+this.currentvisibility};(function(a){a.widget("ui.orgDiagram",jQuery.ui.mouse2,new primitives.orgdiagram.Controller)})(jQuery);
