  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body pu-scroll-vertical" style="height:540px">
        ...
        <div class="media">
          <div class="media-left"> <a href="#"> <img width="150" alt="64x64" class="thumbnail media-object" src="<?php echo ($resURL)?>img/report0.png"> </a> </div>
          <div class="media-body">
            <div class="col-sm-10"><a href="#" class="media-heading visited">New look and feel Report Builder</a>
