 ...
 <?php $project_name = "PageUp"; ?>
<!DOCTYPE html>

<head>
<meta charset="utf-8">
<title><?php echo($project_name)?>GEL - Let’s speak the same language</title>
...
<div class="navbar navbar-default navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header"> <a class="navbar-brand" href="#"><strong><?php echo($project_name)?></strong> GEL</a> <span> <small> - Let’s speak the same language</small></div>
...
<div class="row">
  <h1 class="page-header">Global Experience Language</h1>
  <?php showDocs(); ?>
</div>
<!--/.row-->
<div class="row">
