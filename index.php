...
<div class="row">
  <div class="col-sm-8 col-sm-offset-2">
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="pu-box text-center">
          ...
          Demonstrating respect for user and user's attention through thoughtful and elegant craftsmanship.
        </div>
      </div>
      <div class="col-sm-6">
        <div class="pu-box text-center">
          <h4>Digestible</h4>
          Organizing with hierarchy that helps highlight the more common choices, which allows user to find what they’re looking for faster.
        </div>
      </div>
      <div class="col-sm-6">
        <div class="pu-box text-center">
    ...
    <div class="row row-gap">
      <div class="col-sm-6">
        <div class="pu-box text-center">
          <svg class="pu-line-icon" viewBox="0 0 42 32" width="100%" height="100%">
          ...
          <h4><a href="layouts/t1">Template 1</a></h4>
          <p>Detail page</p>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="pu-box text-center">
          ...
          <h4><a href="layouts/t2">Template 2</a></h4>
          <p>Data list pages</p>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="pu-box text-center">
          ...
          <h4><a href="layouts/t3">Template 3</a></h4>
          <p>Home pages</p>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="pu-box text-center">
          ...
          <h4><a href="layouts/t4">Template 4</a></h4>
          <p>Search pages</p>
        </div>
      </div>
    </div>
